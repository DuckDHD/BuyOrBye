...
/*
Request AddIncomeDTO dto
Request to add a new income source with amount and frequency
*/
...
/*
Request UpdateIncomeDTO dto
Request to update an existing income source with optional fields
*/
...
/*
Response IncomeResponseDTO dto
Income details in API responses with timestamps and status
*/
...
/*
Response IncomeListResponseDTO dto
List of income sources with total information
*/
type IncomeListResponseDTO struct {
	Incomes []IncomeResponseDTO `json:"incomes"`
...
/*
Request AddExpenseDTO dto
Request to add a new expense with category, amount, and priority
*/
...
/*
Request UpdateExpenseDTO dto
Request to update an existing expense with optional fields
*/
...
/*
Response ExpenseResponseDTO dto
Expense details in API responses with category and priority information
*/
...
/*
Response ExpenseListResponseDTO dto
List of expenses with total information
*/
type ExpenseListResponseDTO struct {
	Expenses []ExpenseResponseDTO `json:"expenses"`
	Total    int                  `json:"total"`
}
...
/*
Request AddLoanDTO dto
Request to add a new loan with lender, type, and payment details
*/
...
/*
Request UpdateLoanDTO dto
Request to update an existing loan with optional fields
*/
...
/*
Response LoanResponseDTO dto
Loan details in API responses with lender and payment information
*/
...
/*
Response LoanListResponseDTO dto
List of loans with total information
*/
...
/*
Response FinanceSummaryResponseDTO dto
Financial summary with income, expenses, and debt analysis
*/
...
// FromDomainIncome creates IncomeResponseDTO from domain.Income
func FromDomainIncome(income domain.Income) IncomeResponseDTO {
...
// FromDomainIncomeList creates slice of IncomeResponseDTO from slice of domain.Income
func FromDomainIncomeList(incomes []domain.Income) []IncomeResponseDTO {
	dtos := make([]IncomeResponseDTO, len(incomes))
	for i, income := range incomes {
		dtos[i] = FromDomainIncome(income)
	}
	return dtos
}

// FromDomainExpense creates ExpenseResponseDTO from domain.Expense
func FromDomainExpense(expense domain.Expense) ExpenseResponseDTO {
...
// FromDomainExpenseList creates slice of ExpenseResponseDTO from slice of domain.Expense
func FromDomainExpenseList(expenses []domain.Expense) []ExpenseResponseDTO {
	dtos := make([]ExpenseResponseDTO, len(expenses))
	for i, expense := range expenses {
		dtos[i] = FromDomainExpense(expense)
	}
	return dtos
}

// FromDomainLoan creates LoanResponseDTO from domain.Loan
func FromDomainLoan(loan domain.Loan) LoanResponseDTO {
...
// FromDomainLoanList creates slice of LoanResponseDTO from slice of domain.Loan
func FromDomainLoanList(loans []domain.Loan) []LoanResponseDTO {
	dtos := make([]LoanResponseDTO, len(loans))
	for i, loan := range loans {
		dtos[i] = FromDomainLoan(loan)
	}
	return dtos
}

// FromDomainFinanceSummary creates FinanceSummaryResponseDTO from domain.FinanceSummary
func FromDomainFinanceSummary(summary domain.FinanceSummary) FinanceSummaryResponseDTO {
	return FinanceSummaryResponseDTO{
